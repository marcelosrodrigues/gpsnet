...
import com.pmrodrigues.gnsnet.security.UserAuthentication;
...
public class UserController {
    ...
    public UserController(final UserService userService, GroupService groupService, CompanyRepository companyRepository, final Result result, Validator validator){
    ...
    public void prepareNewUser() {
        ...
        result.include(Constante.EMPRESAS,companyRepository.list());
    ...
    public void create(final Usuario usuario, final Grupo[] grupos) {
        ...
        try {
            ...
            final Usuario authenticated = (Usuario) userAuthenticated.getPrincipal();

            if( authenticated.getEmpresa() != null ) {
                usuario.setEmpresa(authenticated.getEmpresa());
            }
