...
<div class="col-lg-12">
        ...
        <div class="row">
            <div class="col-sm-4">
                <div class="form-group">
                    <input type="text" name="object.nome" id="object.nome" placeholder="<fmt:message key='usuario.nome' bundle='${labels}'  />" class="form-control" />
                </div>
            </div>
            <div class="col-sm-4">
                <div class="form-group">
    ...
    <table class="table table-striped table-bordered table-hover">
        ...
        <tr>
            <th style="width:5%">#</th>
            <th style="width:35%"><fmt:message key="usuario.nome" bundle="${labels}"/></th>
